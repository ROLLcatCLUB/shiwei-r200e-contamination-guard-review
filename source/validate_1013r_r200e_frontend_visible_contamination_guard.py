...
def main() -> None:
    ...
    result = {
        ...
        "summary": {
            ...
            "default_visible_source_type_counts": _count_by_source([entry for entry in all_entries if entry.get("default_visible")]),
            "teacher_main_source_type_counts": _count_by_source([entry for entry in all_entries if entry.get("teacher_main_text")]),
        },
        "cases": case_results,
